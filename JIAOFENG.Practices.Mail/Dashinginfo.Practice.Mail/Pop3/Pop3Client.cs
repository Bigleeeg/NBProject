...
using JIAOFENG.Practices.Mail.Pop3.Common;
using JIAOFENG.Practices.Mail.Pop3.Common.Logging;
using JIAOFENG.Practices.Mail.Pop3;

namespace JIAOFENG.Practices.Mail.Pop3
{
	/// <summary>
	...
	/// </example>
    public class Pop3Client : Disposable, IMailReceive
	{
