...
namespace JIAOFENG.Practices.Mail.Pop3.Mime.Decode
{
	/// <summary>
	/// Utility class used by JIAOFENG.Practices.Mail for mapping from a characterSet to an <see cref="Encoding"/>.<br/>
	/// <br/>
