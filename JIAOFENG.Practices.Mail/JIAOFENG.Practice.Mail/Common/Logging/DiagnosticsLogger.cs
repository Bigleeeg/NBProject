...
namespace JIAOFENG.Practices.Mail.Pop3.Common.Logging
{
	/// <summary>
	...
	public class DiagnosticsLogger : ILog
	{
		...
		public void LogError(string message)
		{
			...
			System.Diagnostics.Trace.WriteLine("JIAOFENG.Practices.Mail: " + message);
		}
		...
		public void LogDebug(string message)
		{
			...
			System.Diagnostics.Trace.WriteLine("JIAOFENG.Practices.Mail: (DEBUG) " + message);
		}
	}
}